...
export async function addRoleToAsset(roleId: number, assetId: number, assetType: string) {
    try {
...
export async function removeRoleFromAsset(roleId: number, assetId: number, assetType: string) {
    try {
